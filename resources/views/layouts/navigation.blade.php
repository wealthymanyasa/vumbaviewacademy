            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->is_admin)
                        ...
                        <x-nav-link :href="route('admin.fees-receipts')" :active="request()->routeIs('admin.fees-receipts')">
                            {{ __('Fees Receipts') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin.uniforms-receipts')" :active="request()->routeIs('admin.uniforms-receipts')">
                            {{ __('Uniforms Receipts') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin.buslevies-receipts')" :active="request()->routeIs('admin.buslevies-receipts')">
                            {{ __('Bus Levies Receipts') }}
                        </x-nav-link>
                    @endif
                </div>
            </div>
