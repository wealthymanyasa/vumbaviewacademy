            ...
            <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10 pb-10 space-y-6">
                <div class="border-l-4 border-purple-300 flex justify-between">
                    ...
                    <div class="flex items-center">
                        <a href="{{ route('admin.uniforms-receipts') }}"
                ...
                <div class="mt-6 border border-gray-200 p-4 w-full rounded-lg space-y-4 dark:border-gray-700">
                    ...
                    @forelse ($uniforms as $uniform)
                        <div class="grid grid-cols-5 gap-2">
                            <div class="">
                                <p class="font-medium text-gray-800 dark:text-gray-200">Term {{ $uniform->term }}
                                    of {{ $uniform->academic_year }}</p>
                            </div>
                            ...
                            <div>
                                <p class="text-gray-800 dark:text-gray-200">{{ $uniform->receipt_number }}</p>
                            </div>
                            <div>
                                <p class="text-gray-800 dark:text-gray-200">${{ $uniform->balance }}</p>
                            </div>
                            <div>
                                <p class="text-gray-800 dark:text-gray-200">${{ $uniform->amount }}</p>
                            </div>
                    ...
                    @empty
                        <div scope="row max-w-[200px] " colspan="4"
                            ...
                            </p class="text-center">No transactions for uniforms found</p>
                        </div>
                    @endforelse
                </div>
                </table>
