        ...
        <div class=" p-4 space-y-6">
            <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10 pb-10 space-y-6">
                <div class="border-l-4 border-purple-300 flex justify-between">
                    <span class="p-4 uppercase font-semibold "> vumba view academy Bus Levies Invoice </span>

                    <div class="flex items-center">
                        <a href="{{ route('admin.buslevies-receipts') }}"
                ...
                <div class="mt-6 border border-gray-200 p-4 w-full rounded-lg space-y-4 dark:border-gray-700">
                    ...
                    @forelse ($buslevies as $buslevie)
                        <div class="grid grid-cols-5 gap-2">
                            <div class="">
                                <p class="font-medium text-gray-800 dark:text-gray-200">Term {{ $buslevie->term }}
                                    of {{ $buslevie->academic_year }}</p>
                            </div>

                            <div>
                                <p class="text-gray-800 dark:text-gray-200">{{ $buslevie->date_of_payment }}</p>
                            </div>
                            <div>
                                <p class="text-gray-800 dark:text-gray-200">{{ $buslevie->receipt_number }}</p>
                            </div>
                            <div>
                                <p class="text-gray-800 dark:text-gray-200">${{ $buslevie->balance }}</p>
                            </div>
                            <div>
                                <p class="text-gray-800 dark:text-gray-200">${{ $buslevie->amount }}</p>
                            </div>
                    ...
                    @empty
                        <div scope="row max-w-[200px] " colspan="4"
                            ...
                            </p class="text-center">No transactions for buslevies found</p>
                        </div>
                    @endforelse
                </div>
                </table>
